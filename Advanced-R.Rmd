...
2. The following code accesses the mean function in multiple different ways. Do they ll point to the same underlying function object? Verify with `lobstr::obj_addr`.
```
mean
base::mean
get("mean")
