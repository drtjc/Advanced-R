...
**A**: The character `X` is prepended if necessary. All invalid characters are translated to `.`. A missing value is translated to `NA`. Names which match R keywords have a `.` appended to them. Duplicated values are altered by `make.unique`.
